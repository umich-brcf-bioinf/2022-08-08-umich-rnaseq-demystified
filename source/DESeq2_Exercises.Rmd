...
Then write a command to generate the PCA projections using the `plotPCA` function from DESeq2. for the top 500 genes for `intgroup` = 'condition', using the normalized data, as an object named `p.all`. 
